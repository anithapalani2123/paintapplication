...
<html lang="en">
  <head>
    ...
    <style>
        ...
        #myCanvas{
          ...
          border-radius: 2px;
          border: 5px dotted #0f0102;
        }
        #buttonstyle{
          background-color: #d1a1a1;
          border: 2px solid #180103;
          border-radius: 5px;
          color: rgb(10, 9, 9);
          padding: 15px 32px;
          text-align: center;
  ...
  <body id="bgimg">
    <div id="content">
      ...
      <center>
      <button onclick="change_color(this)" id="shooky" style="background: black;"></button>
      ...
      <button onclick="change_color(this)" id="shooky" style="background: rgb(221, 209, 209);"></button>
      </center>
    ...
    color:#320C0E;
    font-weight: bold;
    font-size: larger;">Paint Application Program, Developed by Anitha Palani.</p>
  </body>
</html>
